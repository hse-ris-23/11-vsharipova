...
namespace CarLibrary
{
    public class LightCar : Car
    {
        ...
        public LightCar(IdNumber idNumber, string brand, int year, string color, int cost, int clearance, int countPlaces, int maxSpeed) : base(idNumber, brand, year, color, cost, clearance)
        {
            CountPlaces = countPlaces;
            MaxSpeed = maxSpeed;
        }
        ...
        public Car BaseCar
        {
            get
            {
                return new Car(Brand, Year, Color, Cost, Clearance);
            }
        }
        ...
        public override void Init()
        {
            ...
            CountPlaces = int.Parse(Console.ReadLine());
