...
{
    public class Car : IInit, IComparable
    {
        ...
        {
            Console.Write($"Id = {IdNumber}, Модель = {Brand}, Год выпуска = {Year}, Цвет = {Color}, Стоимость = {Cost}, Дорожный просвет = {Clearance}");
        }
        ...
        {
            return $"Id = {IdNumber.Number}, Модель = {Brand}, Год выпуска = {Year}, Цвет = {Color}, Стоимость = {Cost}, Дорожный просвет = {Clearance}";
        }
        ...
        public object Clone()
        {
            return new Car(new IdNumber(IdNumber.Number), Brand, Year, Color, Cost, Clearance);
        }
